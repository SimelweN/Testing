    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Transfer management functionality has been disabled
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Alert className="border-red-200 bg-red-50">
            ...
            <AlertDescription className="text-red-800">
              <strong>Transfer Management Disabled:</strong> All automated transfer functionality through Paystack 
          ...
          <div className="mt-6 p-6 bg-gray-50 rounded-lg text-center">
            ...
            <p className="text-gray-500">
              Transfer management and automated payments have been removed for security.
              <br />
