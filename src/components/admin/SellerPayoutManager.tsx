...
export const SellerPayoutManager: React.FC = () => {
  ...
  const loadReceipts = async () => {
    ...
    try {
      ...
      setIsUsingMockData(!tableExists);
      if (!tableExists) {
      ...
      {isUsingMockData && (
        <Alert className="border-yellow-200 bg-yellow-50 mb-4">
          ...
          <AlertDescription className="text-yellow-800">
            <strong>Demo Mode:</strong> The seller payouts database table is not configured. This interface is showing demo data for testing purposes.
            Contact your system administrator to set up the seller payouts system.
          </AlertDescription>
        </Alert>
      )}
