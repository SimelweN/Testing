...
} from "@/utils/edgeFunctionDebugger";
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Advanced debugging tool to diagnose edge function failures with
                ...
                {diagnostics.map((diagnostic, index) => (
                  ...
                  >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Badge variant="outline">
                            {diagnostic.timing.toFixed(0)}ms
                          </Badge>
                        </div>
                      </div>
                    </CardHeader>
                    <CardContent className="space-y-3">
                        ...
                        <div className="text-sm space-y-2">
                          ...
                          <div className="bg-red-50 border border-red-200 rounded p-3 space-y-1">
                            ...
                            {diagnostic.error.name && (
                              <div>
                                <strong>Type:</strong> {diagnostic.error.name}
                              </div>
                            )}
                          </div>
                        </div>
                      ...
                      {diagnostic.headers &&
                        Object.keys(diagnostic.headers).length > 0 && (
                          <details className="text-sm">
                            <summary className="font-medium text-muted-foreground cursor-pointer">
                              Response Headers (
                              {Object.keys(diagnostic.headers).length})
                            </summary>
